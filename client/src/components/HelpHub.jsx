...
import { 
  ...
  MessageSquare, ChevronRight, Send, LifeBuoy, RefreshCcw
} from 'lucide-react';
...
const HelpHub = ({ isOpen, onClose }) => {
  ...
  const filteredFAQs = (faqs || []).filter(f => 
    searchMatch(search, f?.question, f?.category)
  );
          ...
          >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="input-field w-full"
                        >
                          <option value="TECHNICAL" className="bg-[#0a0a0a] text-white">Technical Issue</option>
                          <option value="BILLING" className="bg-[#0a0a0a] text-white">Billing Issue</option>
                          <option value="WORKFLOW" className="bg-[#0a0a0a] text-white">Workflow Help</option>
            ...
            <div className="p-8 border-t border-white/[0.05] bg-white/[0.01]">
              <div className="flex items-center justify-between">
                <p className="text-[9px] font-black text-slate-700 uppercase tracking-[0.2em]">FitXeno Intelligence v5.0</p>
