      ...
      <div className="bg-obsidian relative selection:bg-earth-clay/20 min-h-screen text-slate-300">
        ...
        <nav className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
              <Link to="/" className="flex items-center mr-6 group">
                <img src={lionIcon} alt="FitXeno Icon" className="h-16 sm:h-20 w-16 sm:w-20 object-contain scale-[1.30] group-hover:scale-[1.35] transition-transform" />
        ...
        <section id="membership" className="py-24 sm:py-32 lg:py-48 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 w-full">
            ...
            <div className="mt-16 sm:mt-24 text-center opacity-70">
               <div className="w-12 h-px bg-earth-clay/50 mx-auto mb-6" />
               <p className="label-text !text-earth-clay !text-[16px] uppercase tracking-[0.5em] font-bold">Powering Modern Fitness Clubs</p>
            </div>
          </div>
        </section>
      </div>
