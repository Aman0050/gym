...
const MemberProfile = () => {
  ...
  // Build chart data: last 30 days with actual check-in counts (0 on days with no attendance)
  const chartData = (() => {
    // Count check-ins per calendar day
    const countByDay = {};
          ...
          <div className="lg:col-span-8 space-y-6 lg:space-y-8">
            ...
            <FadeIn direction="up" duration={0.4}>
              <Card variant="flat" className="p-7 lg:p-10">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium mt-1">
                      Last 30 days · {attendance.length} check-in{attendance.length !== 1 ? 's' : ''}
                    </p>
                  </div>
                ...
                {chartData.length > 0 ? (
                  <div className="h-52 lg:h-60 w-full min-h-[208px] min-w-0">
