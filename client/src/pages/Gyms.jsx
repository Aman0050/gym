          ...
          <div className="p-6 lg:p-8 border-b border-white/5 bg-white/2 flex flex-col md:flex-row gap-6 lg:gap-8 items-center">
            ...
            <div className="relative flex-1 w-full max-w-md">
              ...
              <input 
                ...
                className="w-full bg-white/[0.04] border border-white/[0.08] rounded-2xl py-4 pl-14 pr-6 text-slate-200 text-xs font-semibold placeholder:text-slate-500 focus:outline-none focus:border-earth-clay/30 transition-all shadow-inner"
              />
            </div>
          </div>
