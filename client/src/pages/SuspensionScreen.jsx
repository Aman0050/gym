...
const SuspensionScreen = ({ reason, timestamp }) => {
  ...
  const handleSupport = () => {
    window.location.href = 'mailto:support@fitxeno.com?subject=Gym Suspension Inquiry';
  };
          ...
          <Card variant="flat" className="max-w-2xl w-full p-8 lg:p-12 border-earth-clay/20 bg-white/[0.02] shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col items-center text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="body-text max-w-[28rem] mx-auto opacity-70">
                  Access to <span className="text-ivory font-bold">{user?.gym_name || 'your gym'}</span> has been temporarily restricted by the FitXeno platform administration.
                </p>
              </div>
              ...
              <div className="flex items-center gap-3 opacity-20">
                ...
                <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">
                  FitXeno Enterprise SaaS Security
                </span>
              </div>
            </div>
          </Card>
