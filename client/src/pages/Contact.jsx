...
import { 
  ...
  Phone, Handshake, BarChart3, Lock,
  ...
  <section className="py-20 lg:py-32 relative z-10 bg-gradient-to-b from-transparent via-obsidian to-obsidian overflow-hidden">
     ...
     <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
           ...
           <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="w-full sm:w-auto px-10 py-5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white text-base font-bold transition-all backdrop-blur-md shadow-xl hover:scale-105">
             Start Free Trial
           </button>
        </div>
     </div>
              ...
              <div className="relative z-10 p-8 sm:p-12 lg:p-16 aura-glass-heavy bg-black/40 ring-1 ring-white/10 shadow-[0_30px_100px_rgba(0,0,0,0.8)] rounded-3xl overflow-hidden backdrop-blur-3xl">
                ...
                <div className="relative z-20">
                  ...
                  >
                     ...
                     <a href="mailto:contact@fitxeno.com" className="w-full sm:w-auto group px-10 py-5 bg-white/[0.03] hover:bg-white/[0.08] backdrop-blur-xl border border-white/10 rounded-xl text-white text-base font-bold transition-all flex justify-center items-center shadow-2xl ring-1 ring-white/5">
                       Direct Contact <Globe size={16} className="ml-3 text-slate-400 group-hover:text-white transition-colors" />
                     </a>
                  </motion.div>
                </div>
              </div>
